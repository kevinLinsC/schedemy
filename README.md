...
2. Execute o script de criação do banco de dados localizado no caminho:
   ```text
   ./schedemy/schedemy/db/db_schedemy.sql
   ```
...
No mesmo diretório (`./schedemy/schedemy`), execute o seguinte comando para iniciar o servidor Spring Boot:
